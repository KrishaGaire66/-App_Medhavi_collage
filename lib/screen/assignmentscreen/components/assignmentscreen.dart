...
import 'package:medhavi/screen/assignmentscreen/components/buildAssignmentCard.dart';
import 'package:medhavi/screen/assignmentscreen/components/studentUploadSection.dart';
...
class _AssignmentScreenState extends ConsumerState<AssignmentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _refreshAssignments() async {
      ...
      await ref.refresh(assignmentProvider.future);
    }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  ...assignments!.map(
                    (assignment) => Buildassignmentcard(assignment: assignment),
                  ),
                  if (isStudent)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
