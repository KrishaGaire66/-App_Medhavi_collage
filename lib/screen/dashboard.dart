...
import 'package:medhavi/screen/homeworkscreen.dart';
import 'package:medhavi/screen/leavenotescreen.dart';
import 'package:medhavi/screen/libraryscreen.dart';
import 'package:medhavi/screen/menu_items.dart';
                    ...
                    switch (menuItems[index].title) {
                      ...
                      case 'Leave Note':
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const Leavenotescreen(),
                          ),
                        );
                        break;
                    }
